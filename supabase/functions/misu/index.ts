...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const reply = finalReply || (draft ? "I’ve prepared that transaction for you to review." : "I’m sorry, I couldn’t complete that request.");
    return response(req, { reply: insightOnly(reply), draft });
  } catch (error) {
